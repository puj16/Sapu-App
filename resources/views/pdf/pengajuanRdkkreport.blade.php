                ...
                <tbody>  
                    @foreach ($rdkk as $nik => $data)
                        ...
                        <tr>
                            ...
                            @foreach ($uniqueNamaPupuk as $pupukNama)
                                ...
                                @endphp
                                <td style="border: 1px solid black;">{{ $rdkkItem->pengajuan_mt1 ?? "X" }}</td>
                                <td style="border: 1px solid black;">{{ $rdkkItem->pengajuan_mt2 ?? "X" }}</td>
                                <td style="border: 1px solid black;">{{ $rdkkItem->pengajuan_mt3 ?? "X" }}</td>
                                <td style="border: 1px solid black;">{{ 
                    ...
                    @endforeach
                        <tr style="border: 2px solid black;">
                            ...
                            @foreach ($uniqueNamaPupuk as $pupukNama)
                                @php
                                    $mt1 = $dataRdkk->where('pupuk.nama_pupuk', $pupukNama)->sum('pengajuan_mt1');
                                    $mt2 = $dataRdkk->where('pupuk.nama_pupuk', $pupukNama)->sum('pengajuan_mt2');
                                    $mt3 = $dataRdkk->where('pupuk.nama_pupuk', $pupukNama)->sum('pengajuan_mt3');
