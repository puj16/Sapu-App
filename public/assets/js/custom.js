  ...
  document.addEventListener("DOMContentLoaded", function() {
    var currentPath = window.location.pathname; // Ambil path tanpa query string
    document.querySelectorAll('.navbar-nav .nav-item').forEach(function(item) {
        var link = item.querySelector('a'); // Ambil elemen <a> dalam <li>
        if (link && link.getAttribute('href') === currentPath) {
            item.classList.add('active'); // Tambahkan class active ke <li>
        }
    });
});
